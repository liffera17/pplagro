 ...
 * @author Vin
 */
public class m_jadwalBibit extends modelInheritence{

    private koneksi kon;
    public static String nama;
    public static String luas;

    public m_jadwalBibit() throws SQLException {
        super();
    ...
    public DefaultTableModel getTable() throws SQLException {
        String header[] = {"Id Jadwal", "Nama Petani", "Tanggal", "Luas"};
        DefaultTableModel tabelModel = new DefaultTableModel(null, header);
        ResultSet rs = kon.getResult("SELECT * from tb_jadwalbibit");
    ...
    public boolean delete(String query) throws SQLException {
        String queries = "DELETE FROM tb_jadwalbibit WHERE id_jadwal =" + query;
    ...
    public boolean save(String query) throws SQLException {
        String queries = "INSERT INTO tb_jadwalbibit VALUES (" + query + ")";
